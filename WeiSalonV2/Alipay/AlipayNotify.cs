...
namespace WeiSalon.Alipay
{
    ...
    public class Notify
    {
        ...
        //支付宝消息验证地址
        private string Https_veryfy_url = "https://mapi.alipay.com/gateway.do?";
        #endregion
        ...
        public bool Verify(SortedDictionary<string, string> inputPara, string notify_id, string sign, string type)
        {
            //获取返回时的签名验证结果
        ...
        {
            string veryfy_url = Https_veryfy_url + "partner=" + _partner + "&notify_id=" + notify_id + "&service=notify_verify";
            //string veryfy_url = Https_veryfy_url + "partner=" + _partner + "&notify_id=" + notify_id + "&service=notify_verify";
